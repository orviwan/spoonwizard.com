...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/orviwan/miranda-website&stack=cms)
...
```
git clone https://github.com/orviwan/miranda-website.git my-blog-name
```
